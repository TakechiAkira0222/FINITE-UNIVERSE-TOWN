...
namespace TakechiEngine.PUN.ServerConnect
{
    /// <summary>
    /// サーバーアクセス時のインターフェース
    /// </summary>
    public interface ConnectTheServer
    {
    ...
    public class TakechiServerConnectPunCallbacks : TakechiPunInformationDisclosure
    {
        /// <summary>
        /// 参考資料
        /// </summary>
